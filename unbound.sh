host=/home/peter/Desktop/host/unbound/hosts.conf
whitelist=/home/peter/Desktop/host/unbound/whitelist.conf
...
sed -i '/./{s/^/local-zone: "&/;s/$/&" always_nxdomain/}' $host
...
sed -i '/./{s/^/local-zone: "&/;s/$/&" transparent/}' $whitelist
