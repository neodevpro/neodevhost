...
```
Total ad / tracking block list 屏蔽追踪广告总数: 185106

Total allowlist list 允许名单总数: 11261

Total combine list 结合总数： 184405

Total deadblock list 失效屏蔽广告域名： 25471

Total deadallow list 失效允许广告域名： 1

Update 更新时间: 2021-12-25
```
### UPTODATE 保持最新<br/>
