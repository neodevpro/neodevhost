...
```
Total ad / tracking block list 屏蔽追踪广告总数: 149161

Total allowlist list 允许名单总数: 4376

Total combine list 结合总数： 149037

Total deadblock list 失效屏蔽广告域名： 25471

Total deadallow list 失效允许广告域名： 103

Update 更新时间: 2021-11-18
```
### UPTODATE 保持最新<br/>
