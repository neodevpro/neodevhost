...
```
Total ad / tracking block list 屏蔽追踪广告总数: 319175

Total allowlist list 允许名单总数: 10872

Total combine list 结合总数： 318565

Total deadblock list 失效屏蔽广告域名： 25471

Total deadallow list 失效允许广告域名： 1111

Update 更新时间: 2023-06-26
```
### UPTODATE 保持最新<br/>
