...
[![Build Status](https://img.shields.io/github/actions/workflow/status/neodevpro/neodevhost/Auto%20Update.yml)](https://github.com/neodevpro/neodevhost/actions?workflow=CI)<br/>
...
```
Total ad / tracking block list 屏蔽追踪广告总数: 249779

Total allowlist list 允许名单总数: 10829

Total combine list 结合总数： 249199

Total deadblock list 失效屏蔽广告域名： 25471

Total deadallow list 失效允许广告域名： 1111

Update 更新时间: 2023-03-12
```
### UPTODATE 保持最新<br/>
