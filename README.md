...
```
Total ad / tracking block list 屏蔽追踪广告总数: 110685

Total allowlist list 允许名单总数: 9996

Total combine list 结合总数： 110260

Total deadblock list 失效屏蔽广告域名： 25472

Total deadallow list 失效允许广告域名： 1113

Update 更新时间: 2022-06-27
```
### UPTODATE 保持最新<br/>
