...
echo | sed -i '13cTotal ad / tracking block list 屏蔽追踪广告总数: echo '$totalad' <br/>' ./README.md  
echo | sed -i '14cTotal whitelist list 白名单总数: echo $totalwhite <br/>' ./README.md  
echo | sed -i '15cUpdate 更新时间: echo '$(date "+%Y-%m-%d %H:%M:%S")' <br/>' ./README.md  
